...
const WovenSewingMachineOperation = () => {
    return (
        <div>
        <Navbar></Navbar>
        <div
          ...
          style={{
            backgroundImage:
              "url(https://i.ibb.co.com/P2XVNd9/Woven-Sewing-Machine-Operation.jpg)",
            width: "w-full",
            height: "320px",
          }}
        >
  ...
  •	6 months trade relevant work experience and pass in a challenge test on vocational skills considered necessary for successful completion of the qualification (Model challenge test to be developed). <br />
            ...
            <p className="">
            •	Interpret Woven Fabrics and Garment <br />
...
•	Make Pants <br />
            ...
            <p className="">
            The Woven Sewing Machine Operation course, designed in alignment with the standards set by the National Skills Development Authority (NSDA_ BNQF Level-2) Bangladesh, equips learners with essential skills, knowledge, and professional attitudes required for excellence in the textile and garment manufacturing industry. This course focuses on the fundamental principles of sewing operations, safety protocols, and practical skills necessary for operating industrial sewing machines effectively.  
            </p>
            <p className=" font-bold md:text-xl text-md mt-4">Course Overview:</p>
            <p className="">
            The Woven Sewing Machine Operation course is a 3-month intensive training program designed for individuals with a minimum Class five Pass or evidence of equivalent achievement qualification, providing a comprehensive foundation in sewing machine operations within the ready-made garments (RMG) sector. Conducted six days a week, with 5-hour daily sessions, the course combines theoretical knowledge with extensive hands-on practice to prepare participants for professional roles in garment manufacturing. Key topics include applying Occupational Safety and Health (OSH) procedures in the workplace, receiving and responding to workplace instructions, and working effectively in team environments. Participants will learn to recognize the RMG business scenario, perform measurements and calculations, and interpret sketches and specifications in manuals. The program covers essential training in preparing for sewing operations, operating industrial sewing machines, and making garments such as pants. Upon completion, graduates will be well-equipped to pursue careers in woven sewing machine operation, with the opportunity to appear for government certification assessments, enabling them to work in both local and international textile industries.
            </p>
            <p className=" font-bold md:text-xl text-md mt-4">
              Course Objectives:
            </p>
            <p className="">
            The primary objective of this course is to equip participants with comprehensive theoretical knowledge and practical skills in woven sewing machine operation, enabling them to perform professional sewing tasks efficiently and safely. By the end of the training, participants will be prepared to interpret technical specifications accurately, operate industrial sewing machines proficiently, and produce high-quality garments according to industry standards. The course ensures graduates are ready to qualify for government certification and pursue rewarding careers in the garment manufacturing sector, both locally and internationally.
            </p>
...
export default WovenSewingMachineOperation;