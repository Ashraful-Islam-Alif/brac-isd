  ...
  return (
    <div>
      ...
      <div className="container mx-auto px-4 md:px-8 lg:px-16 my-8">
        ...
        <p className="mt-4">
          <span className="font-bold md:text-xl text-md ">Weekly Class:</span> 3
          days
        </p>
        <h2 className="mt-4 font-bold md:text-xl text-md">Course Contents:</h2>
        <p>
          Explore the world of Programmable Logic Controllers (PLC) in our
          comprehensive 3-month training program. Acquire in-depth knowledge and
          hands-on experience with various PLC brands, installation of Variable
          Frequency Drives (VFD), and programming techniques.
        </p>
        <p className="mt-4 ">
          <p className="font-bold md:text-xl text-md">-PLC Brands Covered:</p>
          <span>
            Siemens Logo, ER7 200, S7 1200, Delta, Mitsubishi, LS Master K & LS,
            XGB PLC
          </span>
          <p className="font-bold md:text-xl text-md">-VFD Installation:</p>
          <span>
            Learn the installation process of Variable Frequency Drives (VFD)
            for different PLC brands, including: Siemens, Delta, Mitsubishi, LS,
            ABB, Holip, Fracon
          </span>
          <p className="font-bold md:text-xl text-md">
            -Master PLC programming techniques for:
          </p>
          <span>
            Delta and LS HMAE, Stepper Drives, Modbus Communication, Encoder and
            VFD Synchronization
          </span>
        ...
        <p className="">
          Join our PLC training programme and become proficient in programming
          and installing various PLC brands. Develop the skills needed to
          operate and maintain industrial automation systems with confidence.
        </p>

        <h2 className="mt-4 font-bold md:text-xl text-md">Course Overview:</h2>
        <p className="">
          This 3-month training programme covers a wide range of PLC topics,
          including Siemens Logo, ER7 200, S7 1200, Delta, Mitsubishi, LS Master
          K, and LS XGB PLC. Gain hands-on experience in VFD installation for
          Siemens, Delta, Mitsubishi, LS, ABB, Holip, and Fracon PLCs. Learn to
          programme Delta and LS HMAE, configure stepper drives, establish
          Modbus communication, and synchronise encoders and VFDs.
        </p>
        <h2 className="mt-4 font-bold md:text-xl text-md">
