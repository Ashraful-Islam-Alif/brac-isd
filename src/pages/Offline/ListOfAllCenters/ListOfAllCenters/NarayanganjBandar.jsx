    ...
    <div>
      ...
      <div className="my-8 max-w-screen-xl mx-8">
        <h2 className="my-4 text-xl font-bold">
          Available Course of BRAC ISD Bandar (Narayanganj) Centre
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 my-8">
          <div className="mb-6 md:mb-0">
            ...
            <p>Center Lead of BRAC ISD Bandar (Naryanganj)</p>
          ...
          <div className="col-span-1 md:col-span-2" style={mapContainerStyle}>
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d116966.49604530956!2d90.4422666!3d23.6329!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755b1af636fe069%3A0x1263a48796ce60b0!2sBRAC ISD%20Bandar!5e0!3m2!1sbn!2sbd!4v1696920522595!5m2!1sbn!2sbd"
              title="Google Maps"
