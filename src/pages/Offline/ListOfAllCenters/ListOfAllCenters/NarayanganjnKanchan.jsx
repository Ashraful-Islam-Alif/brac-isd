    ...
    <div>
      ...
      <div className="my-8 max-w-screen-xl mx-8">
        <h2 className="my-4 text-xl font-bold">
          Available Course of BRAC ISD Narayanganj Centre
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 my-8">
          ...
          <div className="col-span-1 md:col-span-2" style={mapContainerStyle}>
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d233769.30911284324!2d90.3112798!3d23.7243519!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755cbc128f42133%3A0x8369909673da7232!2sBRAC%20Institute%20of%20Skills%20Development%20(BRAC ISD)%2CKanchon%2CNarayanganj!5e0!3m2!1sen!2sbd!4v1696917521083!5m2!1sen!2sbd"
              title="Google Maps"
